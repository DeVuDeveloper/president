...
RSpec.describe Post, type: :model do
  describe 'For the Post model' do
    before(:each) do
      @user = User.new(name: 'Anna', bio: 'Hello! My name is Yannick.', post_counter: 0)
      @post = Post.new(title: 'Post', text: 'post nr 1', author: @user, comments_counter: 2, likes_counter: 2)
    end
