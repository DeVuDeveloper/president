...
RSpec.feature 'User Index', type: :feature do
  ...
  scenario "I can see the user's profile picture." do
    ...
    first(:link, href: user_post_path(@user2.id)).click
  ...
  scenario 'can see the first comments on a post.' do
    ...
    @user2 = User.create(name: 'Nuri', email: 'photo@gmail.com', password: 'nurisecret')
    Post.create(title: 'Testing with capybara', text: 'test for views', author_id: @user2.id)
    Comment.create(text: ' testing comments', author_id: @user2.id, post_id: @post.id)
  ...
  scenario 'I can see a section for pagination if there are more posts than fit on the view.' do
    ...
    @coment2 = Comment.create(text: 'test comment 2', author_id: @user2.id, post_id: @post.id)
    @coment3 = Comment.create(text: 'test comment 3', author_id: @user2.id, post_id: @post.id)
    @coment4 = Comment.create(text: 'comment 4', author_id: @user2.id, post_id: @post.id)
